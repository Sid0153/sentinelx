...
| 8 | Correlation, incidents, state machine, notes, evidence pins, assignment, activity, timeline, settings | Chain → one incident; window edges; concurrency test | **Done** (see CLAUDE.md for CI status) |
