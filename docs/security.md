...
| Hiding activity inside incidents (unlinking evidence, closing early) | **Implemented (8):** analysts only; unlink and reopen need a reason; every action is incident activity and audit, both append-only; notes cannot be edited; a closed incident is final and new activity opens a new, back-linked incident | 8 |
