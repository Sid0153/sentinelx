...
> **Status: Phase 8 (correlation and incidents) complete.** Sign-in and roles, the audit log,
...
> assignment and a status workflow (`/incidents`). **Not yet:** the dashboard and event pages
> (Phase 9), hunting (Phase 10).
